...
// renombra a src/assets/sol-nav.png
...
export default function HousekeepingDashboard() {
  ...
  // ---- Filtro cliente para métricas/contadores ----
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 text-[#0f172a] font-sans">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {/* Fondo del logo igual al sidebar */}
         <div
  className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg ring-1 ring-slate-200 bg-slate-50"
>
  <img
    src={SolLogo}
    alt="Lanaku Sol"
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold shadow-sm ${
                  selectedRoom && !loading
                    ? "bg-gradient-to-r from-[#304D3C] -600 to-[#304D3C] -700 hover:from-[#304D3C] -700 hover:to-[#304D3C] -800 text-white"
