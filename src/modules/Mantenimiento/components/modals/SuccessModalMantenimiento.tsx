...
import { SUCCESS_MODAL_PALETTE as PALETTE, SUCCESS_MODAL_STYLES } from "../../../housekeeping/components/Modals/successModalHelpers";
...
export default function SuccessModal({
  ...
  message = "Mantenimiento fue asignado correctamente.",
