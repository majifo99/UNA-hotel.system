...
const STATUS_STYLES: Record<Reservation['status'], { label: string; classes: string }> = {
  ...
  checked_in: { label: 'Check-in', classes: 'bg-blue-100 text-blue-800 border-blue-200' },
  checked_out: { label: 'Check-out', classes: 'bg-purple-100 text-purple-800 border-purple-200' },
  no_show: { label: 'No Show', classes: 'bg-gray-200 text-gray-700 border-gray-300' },
  waiting: { label: 'En espera', classes: 'bg-orange-100 text-orange-800 border-orange-200' },
  completed: { label: 'Finalizada', classes: 'bg-slate-100 text-slate-700 border-slate-200' },
};
